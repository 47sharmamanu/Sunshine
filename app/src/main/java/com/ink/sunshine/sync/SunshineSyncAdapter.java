...
import com.ink.sunshine.BuildConfig;
import com.ink.sunshine.MainActivity;
import com.ink.sunshine.R;
import com.ink.sunshine.Utility;
...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            //location provided by user is invalid so couldn't find data
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            //check do we have a response error
